...
export class DeploymentLifecycleManager {
    ...
    private validateTransition(from: GovernanceState, to: GovernanceState) {
        const allowed: Record<string, string[]> = {
            ...
            [GovernanceState.DEPLOYMENT_IN_PROGRESS]: [GovernanceState.DEPLOYMENT_VERIFIED],
            ...
            [GovernanceState.ACTIVATION_IN_PROGRESS]: [GovernanceState.ACTIVE],
            [GovernanceState.ACTIVE]: [GovernanceState.ROLLBACK_ELIGIBILITY_CHECK, GovernanceState.SUSPENDED],
